...
This is a collaborative coding project that I thought would be interesting to do when one of my friend's parent, who's running a steel processing factory, was talking about this problem to me. The code isn't thoroughly tested and still has many bugs, but it's still fun to write.<be>
